...
export const en: Translation = {
  ...
  ui: {
    ...
    graphicsQualityAutoHint: 'Adjusts itself to keep the motion smooth.',
    graphicsQualityCurrent: 'Currently: {level}',
    graphicsQualityLowered:
      'Graphics were lowered so the app keeps running smoothly. You can change this under About.',
    graphicsQualityNoticeDismiss: 'Dismiss',
