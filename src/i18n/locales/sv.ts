...
export const sv: Translation = {
  ...
  ui: {
    ...
    graphicsQualityAuto: 'Auto',
    graphicsQualityHigh: 'Hög',
    graphicsQualityLow: 'Låg',
    graphicsQualityAutoHint: 'Justerar sig själv så att rörelsen håller sig mjuk.',
    graphicsQualityCurrent: 'Just nu: {level}',
    graphicsQualityLowered:
      'Grafiken sänktes för att appen ska fortsätta gå mjukt. Du kan ändra det under Om appen.',
    graphicsQualityNoticeDismiss: 'Stäng',
    aboutOpen: 'Om appen',
