...
const CAMERA_ULTRA_QUALITY_DISTANCE_ENTER_SQ =
  CAMERA_ULTRA_QUALITY_DISTANCE_ENTER ** 2;
const CAMERA_ULTRA_QUALITY_DISTANCE_EXIT_SQ =
  CAMERA_ULTRA_QUALITY_DISTANCE_EXIT ** 2;
