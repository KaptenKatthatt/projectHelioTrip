...
const CAMERA_QUALITY_DISTANCE_ENTER_SQ = 150 * 150;
const CAMERA_QUALITY_DISTANCE_EXIT_SQ = 120 * 120;
const CAMERA_QUALITY_SCALE = 1.12;
const CAMERA_ULTRA_QUALITY_DISTANCE_ENTER_SQ = 260 * 260;
const CAMERA_ULTRA_QUALITY_DISTANCE_EXIT_SQ = 220 * 220;
