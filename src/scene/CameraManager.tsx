...
/** Exported for mobile close-up framing ramp (keep in sync). */
export const CAMERA_TRAVEL_TOTAL_DURATION_MS = AIM_DURATION_MS + FLY_DURATION_MS;
const TOTAL_DURATION_MS = CAMERA_TRAVEL_TOTAL_DURATION_MS;
