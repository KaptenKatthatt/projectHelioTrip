...
type PointerLockControlsChangeEvent = ExtractCallback<PointerLockControlsImpl, 'change'>;
type PointerLockControlsLockEvent = ExtractCallback<PointerLockControlsImpl, 'lock'>;
type PointerLockControlsUnlockEvent = ExtractCallback<PointerLockControlsImpl, 'unlock'>;

type StdlibPointerLockControlsProps = Omit<ThreeElement<typeof PointerLockControlsImpl>, 'args'> & {
...
export const StdlibPointerLockControls = ({
  ...
  useEffect(() => {
    ...
    const centeredPointerCompute: ComputeFunction = (_event: DomEvent, state: RootState) => {
  ...
  useEffect(() => {
    ...
    return () => {
      ...
      if (unlockListener) controls.removeEventListener('unlock', unlockListener);
      for (const element of elements) {
