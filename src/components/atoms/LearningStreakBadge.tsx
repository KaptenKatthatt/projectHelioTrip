...
export const LearningStreakBadge = () => {
  ...
  return (
    <div className="pointer-events-auto inline-flex items-center gap-1 rounded-xl border border-amber-300/35 bg-amber-300/15 px-2.5 py-1 text-xs text-amber-100">
