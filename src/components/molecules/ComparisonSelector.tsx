  ...
  <div className="flex flex-wrap gap-1.5 justify-center">
    {options.map((id) => (
      <button
        ...
        className={[
          "pointer-events-auto rounded-full px-2.5 py-1 text-[11px] font-medium transition-colors focus:outline-none focus-visible:ring-2 focus-visible:ring-white/40",
          compareWith === id
