  ...
  <div className="animate-in fade-in zoom-in fixed inset-0 z-[110] flex flex-col bg-black/98 backdrop-blur-2xl duration-300">
    <div className="absolute top-6 right-6 z-20 flex gap-2">
      <button
        ...
        className="flex h-12 w-12 items-center justify-center rounded-full bg-red-500/10 text-red-500 transition hover:bg-red-500 hover:text-white focus:outline-none focus-visible:ring-2 focus-visible:ring-red-500/50"
        title="Ta bort foto"
