...
> "Inte plugga fakta om rymden – utan *resa* genom den och förstå varför det ser ut som det gör."

Principerna:

| Princip | Vad det innebär i appen |
|---|---|
| **Kontext före fakta** | Lär ut varför solen är stor *i relation till* planeten du just landade på |
...
| **Belöna nyfikenhet** | XP och titlar för att utforska *extra*, inte bara slutföra |
...
- 🌪️ *"Stormens öga"* — Den stora röda fläcken är en storm som rasat i 350 år. Den är dubbelt så stor som hela jorden.
- 🌙 *"Månrika Jupiter"* — Jupiter har 95 kända månar. De fyra största hittade Galileo 1610 med ett hemmagjort teleskop.
- ⚖️ *"Hur tung är du här?"* — På Jupiter väger du 2,5× mer än på jorden. En 40-kilos elev väger 100 kg där.
- 🔴 *"Ingen mark att landa på"* — Jupiter är en gasjätte. Det finns ingenstans att stå – du skulle sjunka in som i ett moln.
...
**Exempeluppdrag (mellanstadiet):** *"Vattenjakten"*
...
3. 🔍 Hitta Europa – läs om det underjordiska havet *(faktakort visas automatiskt)*
...
**Exempeluppdrag (högstadiet):** *"Gravitationsslingans hemlighet"*
...
4. **Fyll i luckan** — "Jupiter har _____ kända månar" med sifferhjul

**Feedbackprincip:** Fel svar ger inte "Fel!" – det ger en ledtråd + möjlighet att svara igen:
> "Inte riktigt! Tips: Tänk på att Jupiter är *så stor* att 1300 jordklot ryms i den."
...
*Plan framtagen 2026-04-27. Revidera när innehållsproduktion startar.*
