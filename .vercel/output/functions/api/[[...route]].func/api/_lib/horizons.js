...
export const fetchHorizonsVectors = async (options) => {
    ...
    if (!response.ok) {
        throw new HorizonsError(`Horizons responded with HTTP ${response.status}`);
    }
...
//# sourceMappingURL=horizons.js.map